...
from messagebird.Feature import ENABLE_CONVERSATIONS_API_WHATSAPP_SANDBOX
import json
...
def webhook_endpoint():
    client = Client(message_bird_api_access_key, features=[ENABLE_CONVERSATIONS_API_WHATSAPP_SANDBOX])
